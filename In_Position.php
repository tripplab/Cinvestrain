...
<center>
    ...
    <iframe id="mainContent" name="mainContent" src="./user/Cat/Catalogos_Ajax/Position/index.php" width="100%" height="150%" frameborder="0" style="margin: 0px; height: 150%;" scrolling="si" onload="resizeMe(this)">
