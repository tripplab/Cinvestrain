...
<div id="baseMenu">
  ...
  if(isset($_POST['btn1']))
 {
    ...
    $Busqueda1=$_POST['buscar'];
             ...
             $consul=  mysql_query(" select imageplant.org_id,imageplant.idImage,imageplant.descripcion,imageplant.ruta,plant_info.Longitud,plant_info.Latitud from imageplant inner join plant_info on imageplant.Org_id=plant_info.Plant_ID where tabla='planta' and Common_Name='$Busqueda1' and imageplant.lab='$consul2' ");
...
var arregloDeCord1 = a2p.split(',');
   ...
   if(isset($_POST['btn2']))
 {
    ...
    $Busqueda1=$_POST['buscar'];
             ...
             $consul=  mysql_query(" select imageplant.org_id,imageplant.idImage,imageplant.descripcion,imageplant.ruta,host_info.Longitude,host_info.Latitude from imageplant inner join host_info on imageplant.Org_id=host_info.ID_Host where tabla='Host' and Name='$Busqueda1' and imageplant.lab='$consul2' ");
 ...
 var posi = new google.maps.LatLng(arregloDeCord1[i], arregloDeCord2[i]);
        ...
        var marker = new google.maps.Marker({
            ...
            animation: google.maps.Animation.DROP
             ...
             $consul=  mysql_query(" select imageplant.org_id,imageplant.idImage,imageplant.descripcion,imageplant.ruta,host_info.Longitude,host_info.Latitude from imageplant inner join host_info on imageplant.Org_id=host_info.ID_Host where tabla='Host' and imageplant.lab='$consul2'  ");
...
var arregloDeCord1 = a2p.split(',');
   ...
   if(isset($_POST['btn3']))
 {
    ...
    $Busqueda1=$_POST['buscar'];
             ...
             $consul=  mysql_query(" select imageplant.org_id,imageplant.idImage,imageplant.descripcion,imageplant.ruta,free_living.Longitude,free_living.Latitude from imageplant inner join free_living on imageplant.Org_id=free_living.ID_Sample where tabla='Free' and Name='$Busqueda1' and imageplant.lab='$consul2' ");
 ...
 var posi = new google.maps.LatLng(arregloDeCord1[i], arregloDeCord2[i]);
        ...
        var marker = new google.maps.Marker({
            ...
            animation: google.maps.Animation.DROP
             ...
             $consul=  mysql_query(" select imageplant.org_id,imageplant.idImage,imageplant.descripcion,imageplant.ruta,free_living.Longitude,free_living.Latitude from imageplant inner join free_living on imageplant.Org_id=free_living.ID_Sample where tabla='Free' and imageplant.lab='$consul2'  ");
