...
?>
       ...
       <tr align="center">
        ...
        <input class="Boton1" type="submit" name="btn3" value=" Buscar " align="center">
       </tr>
        </table> 
            </div>
...
$sql = "select Name from free_living where lab='$consul2'";
$res = mysql_query($sql);
$arreglo_php = array(); 
if(mysql_num_rows($res)==0)
  ...
  while($palabras = mysql_fetch_array($res)){
    array_push($arreglo_php, $palabras["Name"]);
  }
}
