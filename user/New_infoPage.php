...
<div id="tabs">
<ul>
<li onclick="OcultarMapa()"><a href="#tabs-1">Organism information</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-2">Macroscopic Morphology</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-3">Microscopic Morphology</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-4">Growth characteristics</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-5">Preservation of Strains</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-6">DNA</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-7">Genetic Data</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-8">Metabolic Data</a></li>
<li onclick="OcultarMapa()"><a href="#tabs-9">Bioassays Data</a></li>
<li onclick="MostrarMapa()"><a href="#tabs-10">Maps</a></li>
</ul>
<div id="tabs-1">
...
<!--         <td><span class="small">* Org Name: </span></td>-->
    ...
    <tr>
      <td><span class="small">Age: </span></td>
        <td class="small" align="center">
          <b>
              <input onKeyPress="return validarNumero(event)"  class="cajas" type="time" name="age"  size="6" value="<?php echo $var11?>" />
            </b>  Hours
          </td>
    </tr> 
          ...
          <b>
              <?php 
                   echo"<select  class='cajas' name=surface id=surface >"; 
                           ...
                           $sql="SELECT Surface_Morphology_ID FROM surface_morphology where lab='$lab'"; 
                           $result=mysql_query($sql); 
                           $i=0; 
...
<!--          </td>-->
    ...
    <tr>
      <td><span class="small">Age: </span></td>
        <td class="small" align="center">
          <b>
              <input  class="cajas" type="time"  size="6"name="age" value="<?php echo $var21?>" />
            </b>  Hours
          </td>
    </tr> 
...
//             <a href="#" target="_blank"><img border="0" src="Imagenes/Fotos.png" name="pic1" width="158px"></a>
            ...
            ?>
                 ...
                 <div id="tabs-5">
                     <table border="0" width="500px"><tbody><tr><td>
               <div id="panel_preservation">
