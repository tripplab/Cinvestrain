...
?>
<h3>Add new Extraction Method</h3>
...
<form action="javascript: fn_agregar();" method="post" id="frm_per">
    <table class="formulario">
        <tbody>
            ...
            <tr>
                <td>Alias</td>
                <td><input name="nom_per" type="text" id="nom_per" size="40" class="cajas" /></td>
            </tr>
            <tr>
                <td>Description</td>
                <td>
                     <textarea  class="estArea" name="ape_per" type="text" id="ape_per" rows="8" cols="50">
                    </textarea>
	...
	$(document).ready(function(){
		$("#frm_per").validate({
			...
			submitHandler: function(form) {
				var respuesta = confirm('FAre sure to add this record?')
				if (respuesta)
					form.submit();
			}
		});
