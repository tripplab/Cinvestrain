...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="col">
    	<div id="cuerpo">
            <h1><center>Sample from Free Living</center></h1>
                        ...
                        <tr>
                            ...
                            <td >
                                <select name="criterio_ordenar_por" id="criterio_ordenar_por" class="cajas">
                                    <option value="ID_Sample">Id</option>
                                    ...
                                    <option value="Altitude">Altitude</option>
                                      <option value="Type_of_sample">Type of sample</option>
                                	<option value="Characteristics_of_sample">Characteristics of sample</option>
