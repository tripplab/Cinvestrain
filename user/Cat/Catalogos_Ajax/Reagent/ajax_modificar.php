<?php
	...
	$sql = sprintf("UPDATE reagent SET   Alias='%s', Nombre='%s', Marca='%s',Presentacion='%s',Temperature='%s',Contenedor='%s',Comment='%s',lab='%s' where Reagent_ID=%d;",
		...
		fn_filtro(substr($_POST['S_storageM'], 0, 60)),
                fn_filtro(substr($_POST['R_Temperature'], 0, 60)),
