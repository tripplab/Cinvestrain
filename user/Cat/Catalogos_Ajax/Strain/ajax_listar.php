...
{              
    ...
    $paging = new PHPPaging;
	$sql = "select * from strain where lab='$consul2'";
}
           ...
           if($consul1=="Supermanager")                        
{
    ...
    ?>
        <tr id="tr_<?=$rs_per['Strain_ID']?>">
            
            <td><?=$rs_per['Alias']?></td>
            <td><?=$rs_per['Nombre']?>
            <td><?=$rs_per['Tipo_Bacteria']?></td>
             <td><?=$rs_per['Medio_Almacenamiento']?></td>
            <td><?php 
           ...
           if($consul1=="Supermanager")                        
{
	 ...
	 <td><?php echo $consullab ?></td>
        ...
        <?php
            ...
            <td><a href="javascript: fn_mostrar_frm_modificar(<?=$rs_per['Strain_ID']?>);"><img src="../extras/ico/page_edit.png" /></a></td>
            <td><a href="javascript: fn_eliminar(<?=$rs_per['Strain_ID']?>);"><img src="../extras/ico/delete.png" /></a></td>
        </tr>
    <?php } ?>
    </tbody>
    <tfoot>
