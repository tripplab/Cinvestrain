<?php
	...
	$sql = "select Sequencing_Method_ID from sequencing_method order by Sequencing_Method_ID desc limit 1";
	$per = mysql_query($sql);
	$rs_per = mysql_fetch_assoc($per);
	
	/*insertamos el nuevo registro*/
	$ide_per = $rs_per['Sequencing_Method_ID'] + 1;
	...
	$sql = sprintf("INSERT INTO `sequencing_method` VALUES (%d, '%s', '%s', '%s');",
