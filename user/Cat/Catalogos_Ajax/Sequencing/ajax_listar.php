...
{ 
	...
	$sql = "select * from sequencing_method";
}
else{
    
    $paging = new PHPPaging;
	$sql = "select * from sequencing_method where lab='$consul2'";
}
	...
	if (isset($_GET['criterio_ordenar_por']))
		...
		$sql .= " order by Sequencing_Method_ID desc";
           ...
           if($consul1=="Supermanager")                        
{
    ...
    ?>
        <tr id="tr_<?=$rs_per['Sequencing_Method_ID']?>">
           ...
           if($consul1=="Supermanager")                        
{
	 ...
	 <td><?php echo $consullab ?></td>
        ...
        <?php
            ...
            <td><a href="javascript: fn_mostrar_frm_modificar(<?=$rs_per['Sequencing_Method_ID']?>);"><img src="../extras/ico/page_edit.png" /></a></td>
            <td><a href="javascript: fn_eliminar(<?=$rs_per['Sequencing_Method_ID']?>);"><img src="../extras/ico/delete.png" /></a></td>
        </tr>
    <?php } ?>
    </tbody>
    <tfoot>
