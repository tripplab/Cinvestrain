     ...
     var  al=document.getElementById("alt").value;
         ...
         var phot=form.lab.value;
            var subir=document.getElementById("sub").value;
             var otro=document.getElementById("oth").value;
             
           $.ajax({  
         type:"POST",  
        url: "BD_Plant.php",
      data:{plan:numeroplan,org:numeroorg,com:co,sci:sc,gen:ge,spe:sp,date:da,col:c,sia:si,sid:s,lon:lo,Lat:la,alt:al,tis:ti,hei:he,wid:wi,phy:ph,nei:ne,soil:soi,storage:stor,comm:com,pho:phot,sub:subir,oth:otro}
...
<form   id="form_mapa" name="form_mapa" method="POST" action="" enctype="multipart/form-data" >
    ...
    <div>
        ...
        <input class="cajas" type="text" name="com" id="com" required>
    </div>
      <br>
    <div>
        <label>Scientific Name</label>
        <input  class="cajas" type="text" name="sci" id="sci" >
    </div>
       <br>
    <div>
        <label>Gender</label>
        <input class="cajas" type="text" name="gen" id="gen" >
    </div>
        <br>
     <div>
        <label>Species</label>
        <input class="cajas"type="text" name="spe" id="spe" >
    </div>
         <br>
    <div>
        <label>*Date of collection</label>
        <input class="cajas" type="date" name="date" id="date" required   max="<?php echo $fechaMax;?>">
    </div>
      <br>
    <div>
...
echo '</select>';
    ...
    <div>
        ...
        <input class="cajas" type="text" name="direccion" id="direccion"  value="<?php echo $direccion;?>" required>
    </div>
        <br>
     </div> 
     <div style='height: 500px; width: 250px;  float: left;'>
    ...
    <div>
        ...
        <input class="cajas" type="text" name="alt" id="alt"  size="7" onKeyPress="return validar_monto(event)">MALS
    </div> 
           <br>
    <div>
        <label> Tissues</label>
...
<input type="text" name="oth" id="oth">
    ...
    <div>
        <label> Heigth</label>
        <input class="cajas" type="text" name="hei" id="hei" onKeyPress="return validar_monto(event)" size="7"> cm
    </div> 
    ...
    <div>
        <label> Width</label>
        <input class="cajas" type="text" name="wid" id="wid" onKeyPress="return validar_monto(event)"  size="7">cm
    </div> 
      <br>
    <div>
...
echo '</select>';
    ...
    <div>
        ...
        <input class="cajas" type="text" name="comm" id="comm" >
    </div>
         <br>
    <div>
<!--        <input type="hidden" id="pho" name="pho" value="<?php echo $consul2?>">-->
         </div>
	  ...
	  <label>Lab </label>
        ...
        <center>
            <input type="button" class="button1" name="btn1"  id="enviar" value="Add" onclick="return ValidarFormulario(form_mapa);"/>
