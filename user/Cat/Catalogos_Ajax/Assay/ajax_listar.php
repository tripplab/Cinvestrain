...
if($consul1=="Supermanager")                        
{
	...
	$sql = "select * from assay_type ";
        
}
else{
    $paging = new PHPPaging;
	$sql = "select * from assay_type where lab='$consul2'";
}
	...
	if (isset($_GET['criterio_ordenar_por']))
		...
		$sql .= " order by Assay_Type_ID desc";
           ...
           if($consul1=="Supermanager")                        
{
    ...
    ?>
        <tr id="tr_<?=$rs_per['Assay_Type_ID']?>">
           ...
           if($consul1=="Supermanager")                        
{
	 ...
	 <td><?php echo $consullab ?></td>
        ...
        <?php
            ...
            <td><a href="javascript: fn_mostrar_frm_modificar(<?=$rs_per['Assay_Type_ID']?>);"><img src="../extras/ico/page_edit.png" /></a></td>
            <td><a href="javascript: fn_eliminar(<?=$rs_per['Assay_Type_ID']?>);"><img src="../extras/ico/delete.png" /></a></td>
        </tr>
    <?php } ?>
    </tbody>
    <tfoot>
