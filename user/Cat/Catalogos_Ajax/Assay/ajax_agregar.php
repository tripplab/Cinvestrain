<?php
	...
	$sql = "select Assay_Type_ID from assay_type order by Assay_Type_ID desc limit 1";
	$per = mysql_query($sql);
	$rs_per = mysql_fetch_assoc($per);
	
	/*insertamos el nuevo registro*/
	$ide_per = $rs_per['Assay_Type_ID'] + 1;
	...
	$sql = sprintf("INSERT INTO `assay_type` VALUES (%d, '%s', '%s', '%s','%s');",
