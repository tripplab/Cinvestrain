<?php 
		class Conexion{
			...
			function Conexion(){
				$this->host="localhost"; //
				$this->usuario="jcabello"; //usuario que tengas definido
				$this->contrasena="radamanthys123"; //contraseña que tengas definidad
				$this->baseDatos="jcabello_cepario2"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
