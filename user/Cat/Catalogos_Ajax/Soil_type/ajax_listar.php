...
{ 
	...
	if (isset($_GET['criterio_ordenar_por']))
		...
		$sql .= " order by Soil_type_ID desc";
           ...
           if($consul1=="Supermanager")                        
{
    ...
    ?>
        <tr id="tr_<?=$rs_per['Soil_type_ID']?>">
             <td><?=$rs_per['Alias']?>
            <td><?=$rs_per['PH']?></td>
           
            <td><?=$rs_per['Organic_matter']?></td>
           ...
           if($consul1=="Supermanager")                        
{
	 ...
	 <td><?php echo $consullab ?></td>
        ...
        <?php
            ...
            <td><a href="javascript: fn_mostrar_frm_modificar(<?=$rs_per['Soil_type_ID']?>);"><img src="../extras/ico/page_edit.png" /></a></td>
            <td><a href="javascript: fn_eliminar(<?=$rs_per['Soil_type_ID']?>);"><img src="../extras/ico/delete.png" /></a></td>
        </tr>
    <?php } ?>
    </tbody>
    <tfoot>
