...
<form action="javascript: fn_agregar();" method="post" id="frm_per">
    <table class="formulario">
        <tbody>
            ...
            <tr>
                <td>*PH</td>
                <td><input name="usu_per" type="text" id="usu_per" size="16" class="cajas" required onkeypress="return soloNumeros(this, event)" /></td>
            </tr>
           
            <tr>
                <td>Organic matter</td>
                <td>
                    <input type="text" name="ape_per"  id="ape_per" size="40" class="cajas" >
