...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Physiological state</title>
    ...
    <body class="col">
    	<div id="cuerpo">
            <h1><center>Physiological state</center></h1>
