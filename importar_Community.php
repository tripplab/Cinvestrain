...
<body>
    ...
    <br>
     <br>
    <br>
   <center> <h3> Select file Community type to import:</h3></center>
    ...
    if ($action == "upload") {
        ...
        if (file_exists("bak_" . $archivo)) {
            ...
            for ($i = 3; $i <= $totalRe; $i++) {
                ...
                $_DATOS_EXCEL[$i]['Type'] = $objPHPExcel->getActiveSheet()->getCell('C' . $i)->getCalculatedValue();
                  $_DATOS_EXCEL[$i]['Level'] = $objPHPExcel->getActiveSheet()->getCell('D' . $i)->getCalculatedValue();
        ...
        foreach ($_DATOS_EXCEL as $campo => $valor) {
            $sql = "INSERT INTO community_type VALUES (NULL,'";
