...
<body>
    ...
    <br>
     <br>
    <br>
   <center> <h3> Select file soil type to import:</h3></center>
    ...
    if ($action == "upload") {
        ...
        if (file_exists("bak_" . $archivo)) {
            ...
            for ($i = 3; $i <= $totalRe; $i++) {
                ...
                $_DATOS_EXCEL[$i]['PH'] = $objPHPExcel->getActiveSheet()->getCell('C' . $i)->getCalculatedValue();
                  $_DATOS_EXCEL[$i]['Organic_matter'] = $objPHPExcel->getActiveSheet()->getCell('D' . $i)->getCalculatedValue();
        ...
        foreach ($_DATOS_EXCEL as $campo => $valor) {
            $sql = "INSERT INTO soil_type VALUES (NULL,'";
